...
> **5.4.0 が出ました。** 画面表示が英語・日本語に加えて **简体中文 / 繁體中文 / 한국어**に対応しました。
> 上げっぱなしのサーバでも、detached セッションの掃除を**起動時だけでなく定期的に**回せます。そして
> **Markdown プレビューが読んでいた位置に戻る**ようになり、エージェントが裏でそのファイルを書き換えても
> そこに留まります。[セットアップガイド](v5.4.0.html)
