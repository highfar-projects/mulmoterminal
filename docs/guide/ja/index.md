...
> **5.5.0 が出ました。** 読めない言語に入っても行き止まりになりません——**ピッカーへの戻り道すべてに
> 英語名が並びます**。そして Google カレンダーへの書き出しが、**Google 側で消した件数を伝える**ように
> なり、反映されなかったローカル削除はそれとは別の小さい数で報告されます。
> [セットアップガイド](v5.5.0.html)
