...
where you want those. A project that declares `worktreeEnv` also gets **a port and a database
name per worktree**, so two of those dev servers do not both reach for 3000 (see
