// How long a session may sit unused before the server ends it, and how often it looks (#1467, #2165).
//
// Both numbers are shown beside the list they govern (Settings → Sessions that survived a restart)
...
// The cadence the sweep repeats on (#2165). Off by default, which is why it needs a control at
// all: a setting whose default is "does nothing" is one nobody discovers by using the app.
