// Which surface the collection plugin's navigation drives.
//
...
/** What a surface must answer for the plugin's views to navigate inside it. The shape is the
 *  nav half of the plugin binding, unchanged — a surface IS the thing those capabilities meant. */
...
const stack: CollectionNavSurface[] = [];

export function pushCollectionNavSurface(surface: CollectionNavSurface): void {
  stack.push(surface);
}

export function popCollectionNavSurface(surface: CollectionNavSurface): void {
